apos.define('apostrophe-notifications', {
  ...
  construct: function(self) {
    ...
    self.reparentContainer = function() {
      console.log("reparentContainer called");
      var topModal = apos.modalSupport.getTopModalOrBody();
      // Remove the existing notification container, and attach it to the top
      // most container...
      $('[data-apos-notification-container]').remove();
      
      self.$container = $('<div class="apos-notification-container" data-apos-notification-container></div>');
      // run this after the modalStackPop or modalStackPush events
      // have happened.
      $(topModal).append(self.$container);
      
      // add to the container here?
      if ($notification) {
        self.addToContainer($notification);
      }
  ...
  afterConstruct: function(self) {
    ...
    // bind events modalStackPop and modalStackPush to run reparentContainer here.
